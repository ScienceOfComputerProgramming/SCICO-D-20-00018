...
-- Inserts event_type
INSERT INTO event_type (name, structure, description)
VALUES ('AirSensors',
        'AirSensors (timestamp string, stationId string, location string, pm2_5 float, pm10 float, o3 float, no2 float, so2 float, co float)',
        'Sensors for AIR Quality'),
       ('WaterSensors', 'WaterSensors (timestamp string, ph float, cl float, o2 float)', 'Sensors for Water Quality');
...
VALUES ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirCO-3')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirCO-4')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirCO-5')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirCO-6')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirNO2-3')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirNO2-4')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirNO2-5')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirNO2-6')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirOzone2')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirOzone3-1')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirOzone3-8')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirOzone4-1')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirOzone4-8')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirOzone5-1')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirOzone5-8')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirOzone6-1')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirPM10-2')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirPM10-3')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirPM10-4')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirPM10-5')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirPM10-6')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirPM25-2')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirPM25-3')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirPM25-4')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirPM25-5')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirPM25-6')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirSO2-3')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirSO2-4')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirSO2-5')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirSO2-6')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirT-1')),
       ((SELECT id FROM event_type WHERE name = 'AirSensors'), (SELECT id from event_pattern WHERE name = 'AirT-6')),
       ((SELECT id FROM event_type WHERE name = 'WaterSensors'), (SELECT id from event_pattern WHERE name = 'WaterPH-3')),
       ((SELECT id FROM event_type WHERE name = 'WaterSensors'), (SELECT id from event_pattern WHERE name = 'WaterCl-3'));